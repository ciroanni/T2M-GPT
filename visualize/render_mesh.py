...
if __name__ == '__main__':
    ...
    print('sample_i: {}, rep_i: {}'.format(sample_i, rep_i))
    npy_path = os.path.join(os.path.dirname(params.input_path), 'motion.npy')
    out_npy_path = npy_path.replace('.npy', '_smpl_params.npy')
